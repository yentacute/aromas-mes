...
import {listStore, reqGetAllMaterialCategory} from "@/api/basic/store.js";
...
export default function useSearch() {
    ...
    const loadData = async () => {
        const {rows,total} = await listStore(formData)
        tableData.list = rows
    ...
    const getOption = async() => {
        ...
        materialCategoryOptions.value = materialCategoryRes.data
    }
    return {
        formData,
        loadData,
