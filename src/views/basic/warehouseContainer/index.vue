...
import {getWarehouseArea} from "@/api/basic/warehouseArea.js";
defineOptions({
  name: "warehouseContainer" // 容器档案
});
const {t} = useI18n()
    ...
    <el-form :model="formData" ref="searchFormRef" :inline="true" v-show="showSearch" labelSuffix=":">
      <el-row :gutter="20">
        <el-col :lg="4" :sm="12" :md="12" :xs="24">
          <el-form-item :label="t('warehouseContainer.containerCode')" prop="containerCode">
            <el-input
                v-model="formData.containerCode"
                :placeholder="t('warehouseContainer.containerCode')"
                clearable
...
<!--        <el-col :lg="4" :sm="12" :md="12" :xs="24">-->
<!--          <el-form-item :label="t('warehouseContainer.warehouseName')" prop="warehouseId">-->
<!--            <el-select v-model="formData.warehouseId" clearable :disabled="isDetails">-->
<!--              <el-option-->
...
<!--          <el-form-item :label="t('warehouseContainer.locationCode')" prop="containerCode">-->
<!--            <el-input-->
<!--                v-model="formData.locationCode"-->
<!--                :placeholder="t('warehouseContainer.locationCode')"-->
<!--                clearable-->
<!--                @keyup.enter="loadData"-->
<!--            />-->
<!--          </el-form-item>-->
<!--        </el-col>-->
<!--        <el-col :lg="4" :sm="12" :md="12" :xs="24">-->
<!--          <el-form-item :label="t('warehouseContainer.containerType')" prop="containerType">-->
<!--            <el-select v-model="formData.containerType" clearable :disabled="isDetails">-->
<!--              <el-option-->
<!--                  v-for="item in warehouseOptions"-->
<!--                  :key="item.id"-->
<!--                  :label="item.warehouseName"-->
...
<!--        </el-col>-->
    ...
    <ctn-table
        ...
        table-key="warehouseContainerId"
    ...
    <!-- 添加或修改对话框 -->
    <el-dialog :title="title" v-model="showHandle" width="30%" append-to-body @close="closeHandle">
      <el-form ref="updateFormRef" label-position="left" :model="updateFormData" :rules="updateFormRules"
               label-suffix="：">
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item :label="t('warehouseContainer.warehouseName')" prop="warehouseId">
              <el-select v-model="updateFormData.warehouseId" clearable :disabled="isDetails" @change="getAllWarehouseLocation">
                <el-option
                    v-for="item in warehouseOptions"
                    :key="item.id"
                    :label="item.warehouseName"
          ...
          <el-col :span="24" v-if="warehouseOptions.length">
            <el-form-item :label="t('warehouseContainer.locationName')" prop="">
              <el-select v-model="updateFormData.warehourseLocationId" clearable :disabled="isDetails">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item :label="t('warehouseContainer.containerCode')" prop="containerCode">
              <el-input v-model="updateFormData.containerCode" :disabled="isDetails" :placeholder="t('input') + t('warehouseContainer.containerCode')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('warehouseContainer.containerType')" prop="containerType">
              <el-input v-model="updateFormData.containerType" :disabled="isDetails" :placeholder="t('input') + t('warehouseContainer.containerType')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('warehouseContainer.containerDescription')" prop="">
              <el-input v-model="updateFormData.containerDescription" :disabled="isDetails" :placeholder="t('input') + t('warehouseContainer.containerDescription')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
