...
<template>
  <div class="app-container">
    <el-form :model="formData" ref="searchFormRef" :inline="true" v-show="showSearch" labelSuffix=":">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item :label="t('storeLocation.warehouseName')" prop="warehouseId">
            <el-select v-model="formData.warehouseId" clearable @change="getAllWarehouseArea">
              <el-option
        ...
        <el-col :span="6" v-if="warehouseOptions.length">
          <el-form-item :label="t('storeLocation.areaName')" prop="warehouseAreaId">
            <el-select v-model="formData.warehouseAreaId" clearable>
              <el-option
        ...
        <el-col :lg="6" :sm="12" :md="12" :xs="24">
          <el-form-item :label="t('storeLocation.locationName')" prop="areaName">
            <el-input
                v-model="formData.locationName"
                :placeholder="t('storeLocation.locationName')"
                clearable
    ...
    <el-dialog :title="title" v-model="showHandle" width="30%" append-to-body @close="closeHandle">
      <el-form ref="updateFormRef" label-position="left" :model="updateFormData" :rules="updateFormRules"
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item :label="t('storeLocation.warehouseName')" prop="warehouseId">
              <el-select v-model="updateFormData.warehouseId" clearable :disabled="isDetails" @change="getAllWarehouseArea">
                <el-option
                    v-for="item in warehouseOptions"
                    :key="item.id"
                    :label="item.warehouseName"
          ...
          <el-col :span="24" v-if="warehouseOptions.length">
            <el-form-item :label="t('storeLocation.areaName')" prop="warehouseAreaId">
              <el-select v-model="updateFormData.warehouseAreaId" clearable :disabled="isDetails">
                <el-option
                    v-for="item in warehouseAreaOptions"
                    :key="item.id"
                    :label="item.areaName"
          ...
          <el-col :span="24">
            <el-form-item :label="t('storeLocation.locationCode')" prop="locationCode">
              <el-input v-model="updateFormData.locationCode" :disabled="isDetails" :placeholder="t('input') + t('storeLocation.locationCode')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('storeLocation.locationName')" prop="locationName">
              <el-input v-model="updateFormData.locationName" :disabled="isDetails" :placeholder="t('input') + t('storeLocation.locationName')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
