    ...
    <el-form :model="formData" ref="searchFormRef" :inline="true" v-show="showSearch" labelSuffix=":">
      <el-row :gutter="20">
        <el-col :lg="5" :sm="12" :md="12" :xs="24">
          <el-form-item :label="t('storeArchives.warehouseName')" prop="warehouseName">
            <el-input
                v-model="formData.warehouseName"
                :placeholder="t('storeArchives.warehouseName')"
                clearable
...
<!--          </el-col>-->
          <el-col :span="24">
            <el-form-item :label="t('storeArchives.warehouseType')" prop="warehouseType">
              <el-select v-model="updateFormData.warehouseType" clearable :disabled="isDetails">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item :label="t('storeArchives.warehouseCode')" prop="warehouseCode">
              <el-input v-model="updateFormData.warehouseCode" :disabled="isDetails" :placeholder="t('input') + t('storeArchives.warehouseCode')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('storeArchives.warehouseName')" prop="warehouseName">
              <el-input v-model="updateFormData.warehouseName" :disabled="isDetails" :placeholder="t('input') + t('storeArchives.warehouseName')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('storeArchives.warehouseDescription')" prop="warehouseDescription">
              <el-input v-model="updateFormData.warehouseDescription" type="textarea" clearable :disabled="isDetails"
                        :placeholder="`${t('input')}${t('storeArchives.warehouseDescription')} `"/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
