...
<template>
  <div class="app-container">
    <el-form :model="formData" ref="searchFormRef" :inline="true" v-show="showSearch" labelSuffix=":">
      <el-row :gutter="20">
        <el-col :lg="4" :sm="12" :md="12" :xs="24">
          <el-form-item :label="t('storeGroup.groupName')" prop="groupName">
            <el-input
                v-model="formData.groupName"
                :placeholder="t('input') + t('storeGroup.groupName')"
                clearable
    ...
    <ctn-table
        ...
        @select="select" ref="tableRef" @queryTable="loadData" v-model:showSearch="showSearch" table-key="storeGroupId"
    ...
    <el-dialog :title="title" v-model="showHandle" width="500px" append-to-body @close="closeHandle">
      <el-form ref="updateFormRef" label-position="left" :model="updateFormData" :rules="updateFormRules"
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item :label="t('storeGroup.groupCode')" prop="groupCode">
              <el-input v-model="updateFormData.groupCode" :disabled="isDetails"  :placeholder="t('input') + t('storeGroup.groupCode')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="t('storeGroup.groupName')" prop="groupName">
              <el-input v-model="updateFormData.groupName" :disabled="isDetails" :placeholder="t('input') + t('storeGroup.groupName')" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
