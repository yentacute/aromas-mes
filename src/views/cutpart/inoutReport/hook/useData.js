...
export default function useData() {
    ...
    const pageData = reactive({
        columnData: [
            ...
            {
                label: t('cutpart.billNo'),
                prop: 'billNo',
                width: 'auto',
                fixed: 'left'
            },
            {
                label: t('cutpart.billDate'),
                prop: 'billDate',
                width: 'auto'
            },
            {
                label: t('cutpart.typeCode'),
                prop: 'typeCode',
                width: 'auto'
            },
            {
                label: t('cutpart.remark'),
                prop: 'remark',
                width: 'auto'
            },
            {
            ...
            {
                label: t('cutpart.createName'),
                prop: 'createName',
                width: 'auto'
            },
            {
                label: t('cutpart.createTime'),
                prop: 'createTime',
                width: 'auto'
            },
           
            {
                label: t('cutpart.modifyName'),
                prop: 'modifyName',
                width: 'auto'
            },
            {
                label: t('cutpart.modifyTime'),
                prop: 'modifyTime',
                width: 'auto'
            }
